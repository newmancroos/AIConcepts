...
//IChatClient client = new OpenAI.OpenAIClient(credentials, options).GetChatClient("openai/gpt-4o-mini").AsIChatClient();

//Create an embedding generator 

IEmbeddingGenerator<string, Embedding<float>> generator = new OpenAIClient(credentials, options)
